...
const BookingDetail = () => {
  ...
  const userFlightId = userPayLoad.data?.map((items) => items.id);
  console.log("userFlightId", userFlightId);

  const flightdetails = userPayLoad.data?.map((item) => item.flightDetails);
  console.log("userFlightDetailsuserFlightDetails", flightdetails);
  const seatsType = flightdetails?.fare?.passengerInfoList?.flatMap(
    (item) => item.passengerInfo.passengerType
  );
      ...
      <div className="dashboard-content-container">
        ...
        <div className="User_card_detail">
          <div className="iti_review_main">
            <div className="d-flex justify-content_start mt-2 mb-4"></div>
                        ...
                        {!isSmallMob && (
                          <div className="d-flex justify-content-between w-100">
                            <div className="d-flex justify-content-start align-self-center w-75">
                              <h5 className="iti_city_font">
                                {
                                  cityNameFunct[
                                    items?.groupDescription[index]
                                      ?.departureLocation
                                  ]
                                }
                              </h5>
                              ...
                              <p className="d-flex align-self-center iti_date_spacing">
                                {" "}
                                {formatCompleteDate(
                                  items?.groupDescription[index].departureDate
                                )}
                              </p>
                            </div>
                            <div className="w-25">
                              <div className="iti_refund_detail">
                                <p>
                                  {items?.fare?.passengerInfoList[0]
                        ...
                        {isSmallMob && (
                          <div className="d-flex justify-content-between w-100">
                            <div className=" align-self-center w-75">
                              ...
                              <p className=" d-flex align-self-center iti_date_spacing iti_mob_spacing">
                                {" "}
                                {formatCompleteDate(
                                  items?.groupDescription[index].departureDate
                                )}
                                    ...
                                    <div>
                                      <div>
                                        <span className="iti_flight_timing">
                                          {" "}
                                          {itm.departure.time.slice(0, 5)}
                                        </span>
                                        <span className="iti_city_code">
                                          {itm.departure.airport}
                                        </span>
                                        {isSmallMob ? (
                                      ...
                                      <div className="iti_content_spacing">
                                        ...
                                        {elapsedTimeFunct(itm.elapsedTime)}
                                      </div>
                                      <div>
                                        <span className="iti_flight_timing">
                                          {itm.arrival.time.slice(0, 5)}
                                        </span>
                                        <span className="iti_city_code">
                                          {itm.arrival.airport}
                                        </span>
                                    ...
                                    <div className="d-flex justify-content-between">
                                      ...
                                      <div className="">
                                        ...
                                        <p className="fd_airport_name fd_space_baggages">
                                          ...
                                          {items?.baggageAllowance[index].unit}
                                        </p>
                                        {seatAvailable &&
                                ...
                                <div className="fd_line_structure">
                                  ...
                                  <div className="fd_icon_wrapper">
                                    <p className="fd_middle_border">
                                      <DirectionsRunIcon />{" "}
                                      {`Short layover ${calculateDuration(
                                        itm.arrival.time,
                                        item[idx + 1].departure.time
                                      )}`}
                                    </p>
                                  </div>
                                  <div className="fd_line"></div>
                ...
                <div className="d-flex justify-content-end">
                  <div key={index}>
                    <Select
                      ...
                      onChange={(event) =>
                        handleChange(event, index, userFlightId[index])
                      }
                      displayEmpty
                        ...
                        id === index && (
                          <div className="d-flex justify-content-start">
                            {item.map((detail, detailIndex) => (
                              <div
                                key={detailIndex}
                                className="m-2 passnagerDetailsTypo"
                              >
                                <h5 className="passnger_pnr_info">
                                  Passenger Info
                                </h5>
                                <p>{`ID: ${detail.id}`}</p>
                                ...
                                <p>{`DOB: ${formatCompleteDate(
                                  detail.dateOfBirth
                                )}`}</p>
                                <p>{`PassportExp: ${formatCompleteDate(
