...
import { AdminCancellationReq } from '../../../API/BackendAPI/UserBookingDetails';
...
const __handleSearch = ()=>{
    ...
    useEffect(()=>{
        const CancellationBookingDetails = async()=>{
            try{
                const responce = await AdminCancellationReq();
                setUserData(responce);
                console.log("CancellationRequestResults",responce);
                setLoading(false);
       ...
       <div className='user_table_details'>
        {userPayLoad?.length ? (
            ...
            <div className='text-center py-5 bg-white'>
                ...
                <h2>No Cancellation Requestss found</h2>
