  ...
  return (
    ...
    <div className="search_bar_components">
        <div className="helpline_main" >
            ...
            <span className="help_right_padding"><HeadsetMicRoundedIcon/></span>+1 (484) 312-1100
            </div>
            <div className="helpline_content">
                    <span className="help_right_padding"><WhatsAppIcon className='text-success'/></span>+1 (484) 312-1100 
            </div>
        </div>
  </div>
</div>
