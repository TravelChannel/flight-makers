           ...
           <ModalBody>
            <div className='row'>
                <div className="col-lg-6 col-md-6 col-sm-6 col-12 ">
                        ...
                        <div className='mt-2 parent-element1'>
                       ...
                       <div className='mt-2 inputs_parents'>
                                {/* <div >
                                    <p className="call_title_typo">From:</p>
                                    <TextField id="outlined-basic"  variant="outlined" size='small' placeholder='Departure' onChange={handleUserDepart} />
                                </div>
                                <div className='mx-1'>
                                        <p className="call_title_typo">To:</p>
                                        <TextField id="outlined-basic"  variant="outlined" size='small' placeholder='Arrival'  onChange = {handleUserArrival}/>
                                </div> */}
