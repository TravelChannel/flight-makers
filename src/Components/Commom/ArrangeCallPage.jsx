  ...
  return (
    <div className="container bg-white">
      <div className="contact_us_heading d-flex justify-content-center">
        <PhoneForwardedIcon className="about_detail_icon " />
        <h3 className="fmBanks_main_heading">Schedule a Call With Our Team</h3>
      </div>
      <div className="row m-2">
        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
          ...
          <div className="call_page_margin parental-element">
            <p className="call_title_typo">
              Phone No <span className="mendatory">*</span>:
            </p>
            <PhoneInput
              country={"us"}
