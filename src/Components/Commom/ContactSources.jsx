      ...
      <div className="d-flex justify-content-around  contact_links flex-wrap">
        <div className="contact_container">
          <a href="tel:03111147111">
            ...
            <p className="contact_phone_no">
              UAN: <span className="contact_ph_size">03111147111</span>
            </p>
          </a>
        </div>
        <div className="contact_container">
          <a href="https://wa.me/923111147111" target="_blank">
            ...
            />
            <p className="contact_phone_no">
              WhatsApp: <span className="contact_ph_size">03111147111</span>
            </p>
          </a>
        </div>
        <div className="contact_container">
          <a href="mailto:support@flightmakers.com">
            <img src={images.Mail} alt="" className="UAN_image" width="48px" />
            <p className="contact_phone_no">
              Email:{" "}
              <span className="contact_ph_size">support@flightmakers.com</span>
            </p>
          </a>
        </div>
      </div>
