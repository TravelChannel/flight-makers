...
// -------------------FlightMakers Images -------------------------------
import flightMakerLogo from "../../src/assets/flightmakers-logo.png";
import customer_support from "../../src/assets/customer_support.png";

export const extra_baggages = [nill_Bagg, standerd_Bagg, extra_Bagg];
export default flightMakerLogo;
