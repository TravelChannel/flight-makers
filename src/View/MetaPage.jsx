...
const MetaPage = ({ children, metaPageData }) => {
  ...
  const aggregateRatingSchema = {
    ...
    description: 'Book flights from Lahore to London with Faremakers. Get the best deals and excellent service.',
    aggregateRating: {
    ...
    const canonicalUrl = metaPageData.find(page => page.url === location.pathname)?.url 
    ? `https://www.faremakers.com${metaPageData.find(page => page.url === location.pathname).url}`
    : `https://www.faremakers.com${location.pathname}`;
